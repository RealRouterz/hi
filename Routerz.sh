...
echo "		 ░ ▒░  ░ ░░▒░ ░ ░   ▒   ▒▒ ░░ ░▒  ░ ░  ▒   ▒▒ ░  ░▒ ░ ▒░ "
echo -e "		   ░   ░  ░░░ ░ ░   ░   ▒   ░  ░  ░    ░   ▒     ░░   ░  $nc"
echo -e "	$red[$green+$red]$cyan Coded by	 $nc : Routerz $red[$green+$red]$nc"
echo -e "	$red[$green+$red]$cyan $6 Monthly  $red[$green+$red]$nc"
echo -e "	$red[$green+$red]$cyan $14 / Lifetime $red[$green+$red]$nc"
echo -e "	$red[$green+$red]$cyan Instagram: @realrouter $red[$green+$red]$nc"
	}
